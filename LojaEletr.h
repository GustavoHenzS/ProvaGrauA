...
class Produto {
public:
	Produto(string n = "", double p = 0.00, string cod = "");
	virtual ~Produto() {};
...
private:
    ...
    int armazenamento;
public:
    Smartphone(string n = "", float p = 0.0, string c = "", string m = "", int a = 0);
...
private:
    ...
    float tamanhoTela;
public:
    Laptop(string n = "", float p = 0.0, string c = "", string m = "", float t = 0.0);
    void setMarca(string m);
    void setTamanhoTela(float t);
    void exibir() const override;
};
...
private:
    ...
    int duracaoBateria;
public:
    Tablet(string n = "", float p = 0.0, string c = "", string m = "", int h = 0);
    void setMarca(string m);
...
public:
    ...
    void aplicarDesconto(string codigo, float percentual);
